...
var crontabsResource = schema.GroupVersionResource{Group: "samplecontroller.k8s.io", Version: "v1alpha1", Resource: "crontabs"}

var crontabsKind = schema.GroupVersionKind{Group: "samplecontroller.k8s.io", Version: "v1alpha1", Kind: "Crontab"}

// Get takes name of the crontab, and returns the corresponding crontab object, and an error if there is any.
func (c *FakeCrontabs) Get(name string, options v1.GetOptions) (result *v1alpha1.Crontab, err error) {
	obj, err := c.Fake.
...
func (c *FakeCrontabs) List(opts v1.ListOptions) (result *v1alpha1.CrontabList, err error) {
	obj, err := c.Fake.
...
func (c *FakeCrontabs) Create(crontab *v1alpha1.Crontab) (result *v1alpha1.Crontab, err error) {
	obj, err := c.Fake.
...
func (c *FakeCrontabs) Update(crontab *v1alpha1.Crontab) (result *v1alpha1.Crontab, err error) {
	obj, err := c.Fake.
...
func (c *FakeCrontabs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Crontab, err error) {
	obj, err := c.Fake.
