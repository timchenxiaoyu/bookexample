...
// FooInterface has methods to work with Crontab resources.
type FooInterface interface {
	Create(*v1alpha1.Crontab) (*v1alpha1.Crontab, error)
	Update(*v1alpha1.Crontab) (*v1alpha1.Crontab, error)
	UpdateStatus(*v1alpha1.Crontab) (*v1alpha1.Crontab, error)
...
func (c *foos) Get(name string, options v1.GetOptions) (result *v1alpha1.Crontab, err error) {
...
func (c *foos) List(opts v1.ListOptions) (result *v1alpha1.CrontabList, err error) {
...
func (c *foos) Create(foo *v1alpha1.Crontab) (result *v1alpha1.Crontab, err error) {
	result = &v1alpha1.Crontab{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) Update(foo *v1alpha1.Crontab) (result *v1alpha1.Crontab, err error) {
	result = &v1alpha1.Crontab{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) UpdateStatus(foo *v1alpha1.Crontab) (result *v1alpha1.Crontab, err error) {
	result = &v1alpha1.Crontab{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Crontab, err error) {
	result = &v1alpha1.Crontab{}
