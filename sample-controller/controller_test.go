...
type fixture struct {
	...
	fooLister        []*samplecontroller.Crontab
...
func newFoo(name string, replicas *int32) *samplecontroller.Crontab {
	return &samplecontroller.Crontab{
		TypeMeta: metav1.TypeMeta{APIVersion: samplecontroller.SchemeGroupVersion.String()},
		ObjectMeta: metav1.ObjectMeta{
			Name:      name,
			Namespace: metav1.NamespaceDefault,
		},
		Spec: samplecontroller.CrontabSpec{
...
func (f *fixture) expectUpdateFooStatusAction(foo *samplecontroller.Crontab) {
...
func getKey(foo *samplecontroller.Crontab, t *testing.T) string {
